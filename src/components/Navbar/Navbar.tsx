...
const Navbar = () => {
  ...
  return (
    <>
      <nav className={`fixed top-0 z-50 w-full border-b border-white/10 bg-black/80 backdrop-blur-xl supports-[backdrop-filter]:bg-black/60 transition-all duration-300 ${isScrolled ? 'bg-black/90 shadow-lg' : ''}`}>
